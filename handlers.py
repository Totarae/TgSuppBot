...
def setup_dispatcher(dp):
    ...
    dp.add_handler(MessageHandler(filters.Filters.chat_type.private, forward_to_chat))
    dp.add_handler(MessageHandler(filters.Filters.chat(TELEGRAM_SUPPORT_CHAT_ID) &
                                  ##filters.Filters.chat_type.private &
                                  filters.Filters.reply,
                                  forward_to_user))
        ##filters.Chat(TELEGRAM_SUPPORT_CHAT_ID, 'private'), forward_to_user))
    ##dp.add_handler(MessageHandler(filters.Filters.reply, forward_to_user))
    return dp
